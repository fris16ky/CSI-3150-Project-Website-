...
var day11 = document.getElementById("vetday");
...
var day24 = document.getElementById("turkeyday");
...
done_btn.addEventListener("click", (e) => {
  ...
  let subMonth = reminderDate.substring(5, 7); //should always get 11 for November
  let subDay = reminderDate.substring(8, 10); //1 to 30. Don't think I need to worry about it getting past the allowed day
  ...
  if (
    ...
    if (reminderContent == "") {
      ...
      day24.style.color = "navy";
      window.confirm(
        "Your reminder has been created, Happy Thanksgiving if you celebrate!"
      );
    }
  } else if (subDay == 25) {
    count25++;
