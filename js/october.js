...
var day31 = document.getElementById("halloween");
...
done_btn.addEventListener("click", (e) => {
  ...
  let subMonth = reminderDate.substring(5, 7); //should always get 10 for October
  ...
  if (
    ...
    if (reminderContent == "") {
      ...
      day31.style.color = "orange";
      window.confirm("Your reminder has been created, Happy Halloween!");
    }
  } else {
